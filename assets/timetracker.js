    ...
    jQuery( document ).ready( function ( $ ){
        ...
        $( '.print-box' ).click( function(){
            ...
            mywindow.document.write( '<html><head><title>AZ Time</title><style>body{font-size:12px;font-family:arial;}table{width:700px;}table .column-workspace,.column-time{width:20%;}td{vertical-align:top;}.screen-reader-text,.hidden,.row-actions,.column-title,.check-column,.column-author,.column-action,.column-date{display:none;}</style></head>' );
